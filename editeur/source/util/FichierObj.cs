...
public static class FichierObj
{
    ...
    public static Mesh Importer(string url)
    {
        OBJLoader o = new OBJLoader();
        return o.Importer(url);

        //meshStruct newMesh = createMeshStruct(url);
                    ...
                    switch (brokenString[0])
                    {
                        ...
                        case "f":
                            ...
                            while (j < brokenString.Length && ("" + brokenString[j]).Length > 0)
                            {
                                ...
                                if (brokenBrokenString.Length == 4) //Some .obj files skip UV and normal
                                {
                                    Debug.Log("quad");
                                }
                                j++;
